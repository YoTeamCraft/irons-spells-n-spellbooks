package io.redspace.ironsspellbooks.spells.weapon;
...
@AutoSpellConfig
public class SniperShotSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(IronsSpellbooks.MODID, "sniper_shot");
    ...
    private final DefaultConfig defaultConfig = new DefaultConfig()
            ...
            .setSchoolResource(SchoolRegistry.BULLET_RESOURCE)
            .setMaxLevel(5)
            .setCooldownSeconds(90)
            .build();

    public SniperShotSpell() {
        this.baseManaCost = 1;
